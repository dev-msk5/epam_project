...
from app.pydantic_schemas.project import ProjectCreate, ProjectUpdate, ProjectOut
...
@router.get("/project/{project_id}/info", response_model=ProjectOut, status_code=status.HTTP_200_OK)
...
@router.put("/project/{project_id}/info", response_model=ProjectOut, status_code=status.HTTP_200_OK)
...
@router.delete("/project/{project_id}", status_code=status.HTTP_204_NO_CONTENT, response_model=None)
...
async def share_project(
    ...
    """Generate a share link for a project and send it via email. Only the project owner can share"""
